...
public class RedisComp {
    ...
    private final Logger LogUtil = LogComp.getLogger(RedisComp.class);

    public RedisComp(RedisTemplate<String, Object> redisTemplate) {
